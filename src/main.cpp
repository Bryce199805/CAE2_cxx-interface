...
int main() {
    ...
    //文件操作测试   HULL_3D_MODEL TRANSVERSE_AREA_CURVE OFFSETS_TABLE

    //上传文件 指定路径，带文件名 hull_parameter_info
    // if (obj.UploadFile("hull_model_and_information_db", "hull_parameter_info", "SampleShip_KCS0001", "TRANSVERSE_AREA_CURVE", "../doc/SampleShip_KCS0000.png")) {
    //     std::cout << "Upload file done." << std::endl;
    // }
    // if (obj.UploadFile("hull_model_and_information_db", "hull_parameter_info", "SampleShip_KCS0000", "HULL_3D_MODEL",
    //                    "../doc/SampleShip_KCS0000.igs")) {
    //     std::cout << "Upload file done." << std::endl;
    // }
    // 下载文件 指定路径，不带文件名
    ...
    // if (obj.GetFile("HuLL_MODEL_AND_INFORMATION_Db", "hull_parameter_info", "SampleShip_KCS0000", "HULL_3D_MODEL",
    //                 object_data)) {
