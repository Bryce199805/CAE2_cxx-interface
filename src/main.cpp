...
//    }
     ...
     // todo 接收的所有用户参数需要考虑大小写的问题

     // 上传文件 指定路径，带文件名 hull_parameter_info
     if (obj.UploadFile("HULL_MODEL_AND_INFORMATION_DB", "HULL_PARAMETER_INFO", "M7081005", "TRANSVERSE_AREA_CURVE", "../doc/blue.png")){
     ...
     if (obj.GetFile("HULL_MODEL_AND_INFORMATION_DB", "HULL_PARAMETER_INFO", "M7081001", "TRANSVERSE_AREA_CURVE",object_data)){
